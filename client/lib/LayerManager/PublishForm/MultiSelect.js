 ...
 */
Ext4.define('HSRS.LayerManager.PublishForm.MultiSelect', {
    
    extend: 'Ext4.form.FieldContainer',
    
    mixins: {
        bindable: 'Ext4.util.Bindable',
        field: 'Ext4.form.field.Field'    
    },
    
    alternateClassName: 'Ext4.ux.Multiselect',
    alias: ['widget.multiselectfield', 'widget.multiselect'],
    
    requires: ['Ext4.panel.Panel', 'Ext4.view.BoundList', 'Ext4.layout.container.Fit'],
    
    uses: ['Ext4.view.DragZone', 'Ext4.view.DropZone'],
     ...
     * This can be a {@link Ext4.toolbar.Toolbar} object, a toolbar config, or an array of buttons/button configs
     * to be added to the toolbar. See {@link Ext4.panel.Panel#tbar}.
     */
    ...
    /**
     * @cfg {Ext4.data.Store/Array} store The data source to which this MultiSelect is bound (defaults to `undefined`).
     * Acceptable values for this property are:
     * <div class="mdetail-params"><ul>
     * <li><b>any {@link Ext4.data.Store Store} subclass</b></li>
     * <li><b>an Array</b> : Arrays will be converted to a {@link Ext4.data.ArrayStore} internally.
     * <div class="mdetail-params"><ul>
     ...
     * An optional set of configuration properties that will be passed to the {@link Ext4.view.BoundList}'s constructor.
    ...
    initComponent: function(){
        ...
        if (!Ext4.isDefined(me.valueField)) {
    ...
    setupItems: function() {
        ...
        me.boundList = Ext4.create('Ext4.view.BoundList', Ext4.apply({
            anchor: 'none 100%',
    ...
    afterRender: function(){
        ...
        if (me.ddReorder && !me.dragGroup && !me.dropGroup){
            me.dragGroup = me.dropGroup = 'MultiselectDD-' + Ext4.id();
        }

        if (me.draggable || me.dragGroup){
            me.dragZone = Ext4.create('Ext4.view.DragZone', {
                view: me.boundList,
        ...
        if (me.droppable || me.dropGroup){
            me.dropZone = Ext4.create('Ext4.view.DropZone', {
                view: me.boundList,
    ...
    markInvalid : function(errors) {
        ...
        me.setActiveErrors(Ext4.Array.from(errors));
     ...
     * submission of forms submitted with the {@link Ext4.form.action.Submit#clientValidation} option set.
     */
    ...
    getSubmitValue: function() {
        ...
        return Ext4.isString(delimiter) ? val.join(delimiter) : val;
    },
    ...
    setupValue: function(value){
        ...
        if (Ext4.isDefined(value)) {
            if (delimiter && Ext4.isString(value)) {
                value = value.split(delimiter);
            } else if (!Ext4.isArray(value)) {
                value = [value];
            }
    ...
    getErrors : function(value) {
        ...
        value = Ext4.Array.from(value || me.getValue());
    ...
    onDestroy: function(){
        ...
        me.bindStore(null);
        Ext4.destroy(me.dragZone, me.dropZone);
        me.callParent();
    },
