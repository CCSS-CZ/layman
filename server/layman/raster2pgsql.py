...
def make_sql_register_overview(options, ov_table, ov_factor):
    ...
    sql = "INSERT INTO %s.raster_overviews( " \
          ...
          (g_rt_schema, catalog, schema, ov_table, options.column, catalog, schema, r_table, options.column, ov_factor)
